...
const Footer =  () => {
  ...
  return (
    <footer className="relative py-16 bg-gray-950 overflow-hidden">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col items-center md:items-start">
            <h4 className="text-white font-medium mb-4 relative">
              ...
              <span className="absolute -bottom-1 left-0 w-12 h-1 bg-cyan-500"/>
            </h4>
        ...
        >
          <p className="flex items-center text-gray-500 text-sm mb-4 md:mb-0">
            <span className="relative px-2 py-1 bg-gray-900 rounded-md mr-2 flex items-center">
              <span className="absolute -top-0.5 -left-0.5 w-1.5 h-1.5 bg-cyan-500 rounded-full animate-pulse"/>
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2/3 h-1 bg-gradient-to-r from-transparent via-cyan-500 to-transparent blur-sm"/>
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/3 h-0.5 bg-gradient-to-r from-transparent via-cyan-500 to-transparent blur-sm"/>
    </footer>
  );
}
